  ...
  return (
    <>
      <main className="p-[10px] pl-[10px] md:pl-[17rem] w-full">
        ...
        {loading ? (
          <div
            className="w-40 h-40 mx-auto border-2 border-white border-t-transparent rounded-full animate-spin"
          />
        ) : (
          <>
            {filteredOrders.length === 0 ? (
              <p className="p-10">No orders found.</p>
            ) : (
              <>
                {/* Filter by status */}
                <div className="flex justify-between items-center p-6">
                      ...
                      <div className="flex justify-between items-start flex-wrap gap-4">
                        ...
                        <div>
                          ...
                          <button
                            ...
                            className="ml-3 bg-red-500 hover:bg-red-600 text-white px-3 py-1"
                          >
                            Delete
                          </button>
                        </div>
