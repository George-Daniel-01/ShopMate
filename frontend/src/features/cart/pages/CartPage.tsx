import { FREE_SHIPPING_THRESHOLD, SHIPPING_FEE, TAX_RATE } from "@/config";
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-green-500">
                      {total >= FREE_SHIPPING_THRESHOLD ? "Free" : `$${SHIPPING_FEE}`}
                    </span>
                  </div>
                  ...
                  <div className="border-t border-[hsla(var(--glass-border))] pt-4">
                    <div className="flex justify-between">
                      ...
                      <span>${(total + total * TAX_RATE + (total < FREE_SHIPPING_THRESHOLD ? SHIPPING_FEE : 0)).toFixed(2)}</span>
                    </div>
                  </div>
                </div>
